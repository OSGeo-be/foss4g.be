...
<html lang="<?php echo $lang['URL_SHORT']; ?>">
	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				<img src="images/foss4gbe.svg" style="width:40%">
				<div class="foss4g"></div>
				<h2><span>FOSS</span><span>4G</span></h2>
				<h3><span>BELGIUM</span><span>2015</span></h3>
				<h4><span><?php echo $lang['CECI_1']; ?></span> <span><?php echo $lang['CECI_2']; ?></span> <span><?php echo $lang['CECI_3']; ?></span></h4>
				<p></p>
				<ul class="actions">
