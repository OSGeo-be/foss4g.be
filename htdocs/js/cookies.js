/* cookieconsent from Silktide https://github.com/silktide/cookieconsent2 */
(function() {
   ...
   */
    var Util = {
     ...
     i.e. queryObject({details: {name: 'Marcos'}}, 'details.name') // -> 'Marcos'
    ...
    var cookieconsent = {
        options: {
            ...
            markup: [
				...
				'<a data-cc-if="options.link" class="cc_more_info" href="{{options.link || "#null"}}" target="_blank">{{options.learnMore}}</a>',
