...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Liefde is leuk maar het moet wel betaalbaar blijven: Een business case voor Open Source</h2>
            ...
            <div class="abstract">
                <p>
                    Het afzetten van kosten, baten en risico's voor de inzet van een Open Source omgeving ten opzichte
                    van een closed omgeving is nog niet vaak door overheden gedaan. Deze presentatie gaat in op de
                    methodiek hoe je zo'n business case opstelt en daarna de cijfers en bevindingen hun werk laat doen.
                </p>
            </div>
        </div>
