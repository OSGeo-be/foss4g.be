...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Personalized Road Access based on Vehicle Characteristics</h2>
            ...
            <div class="abstract">
                <p>
                    The NDW has created an accessibility map using open government data, with all the code available as
                    open-source. Users can directly access the APIs, enabling visualization through QGIS or see the
                    result in the frontend.
                </p>
                <p>
                    The website helps to improve the data quality and helps governments to digitize there
                    information.
                </p>
                <h3>Links</h3>
                <ul>
                    <li>website: <a href="https://bereikbaarheid.staging.ndw.nu/map"
                            target="_blank">https://bereikbaarheid.staging.ndw.nu/map</a></li>
                    <li>code: <a href="https://github.com/ndwnu/" target="_blank">https://github.com/ndwnu/</a></li>
                </ul>
            </div>
        </div>
