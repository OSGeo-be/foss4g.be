...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Ruimtelijke plannen opvragen voor een GIS-viewer - van WFS naar API </h2>
            ...
            <div class="prog-slides icon"><a href="/talk-slides/ruimtelijke-plannen-opvragen-voor-een-gis-viewer-van-wfs-naar-api.pptx"><?php echo $lang['DOWNLOAD_SLIDES'] ?></a>
            <div class="prog-tl">
            ...
            <div class="abstract">
                <p>
                    Met de komst van de Omgevingswet in Nederland is een overgangsfase voor de ruimtelijke plannen
                    ingeluid. De manier waarop ruimtelijke plannen worden opgevraagd is veranderd. In de presentatie
                    wordt ingegaan hoe ruimtelijke plannen uit verschillende bronnen (WFS, API, GML-bestanden op
                    website) konden/kunnen worden opgevraagd en wat dat betekent voor de GIS-viewer van een gemeente.
                    Ook worden de eigen ervaringen met de overstap van Web Feature Services naar API's gedeeld.
                </p>
            </div>
        </div>
