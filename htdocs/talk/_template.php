...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            ...
            <div class="prog-speaker">%%SPEAKER%%</div>
            <div class="prog-lang icon"><?php echo $lang['LANG_%%LANG%%']; ?></div>
            %%THEME%%
            <div class="prog-tl">
                <div class="prog-sched icon"><?php echo $lang['%%DAY%%'] ?>, %%TIME%%</div>
                <div class="prog-track %%TRACK%% icon">%%ROOM%%</div>
            </div>
