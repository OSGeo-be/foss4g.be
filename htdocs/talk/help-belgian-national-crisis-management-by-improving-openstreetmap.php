...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Help Belgian national crisis management by improving OpenStreetMap</h2>
            ...
            <div class="abstract">
                <p>Learn about open National Crisis Center tasks in OpenStreetMap and help us fix issues.</p>

                <p>
                    When preparing OpenStreetMap data for Paragon, we run into recurrent issues. Where possible, we turn
                    these issues into microtasks that can be fixed by the OpenStreetMap community.
                </p>

                <p>
                    In this workshop, we intend to work on these tasks. We'll explain what sources you can use to fix
                    the issues and how to do this on your own PC. A laptop is required, but no software needs to be
                    installed.
                </p>

                <p>Previous OpenStreetMap experience is useful, but not necessary.</p>
            </div>
        </div>
