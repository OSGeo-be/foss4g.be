...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Exploring the power of PCRaster Tools</h2>
            ...
            <div class="abstract">
                <p>
                    PCRaster tools is a powerful package for dynamic modeling. In this presentation, we will explore how
                    PCRaster is used to develop a Stream Power Index in urbanized areas, helping us understand the
                    erosive potential of surface water flows. Additionally, we will see how it is used for calculating
                    stage-volume curves and catchment delineation of water pans, providing crucial insights for water
                    storage and water yield.
                </p>
            </div>
        </div>
