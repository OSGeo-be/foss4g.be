...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>An intro to Point Cloud Processing using PDAL Pipelines</h2>
            ...
            <div class="abstract">
                <p>
                    I want to give an intro to command line processing using PDAL pipelines, and also show some examples
                    with the python API. I plan to also show examples of parallel processing using GNU parallel, since
                    by default PDAL runs in a single thread in a single process.
                </p>
            </div>
        </div>
