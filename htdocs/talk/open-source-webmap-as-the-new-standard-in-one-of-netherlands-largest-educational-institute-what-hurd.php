...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Open Source WebMap as the new standard in one of Netherlands' largest educational institute. What
                hurdles do we need to leap?</h2>
            ...
            <div class="abstract">
                <p>
                    Open Source WebMap (Tailormap) on Hogeschool Utrecht. Questions that will be addressed are, among
                    others: Why do we want to use open-source for sharing our spatial data? What are the hurdles in
                    establishing open-source GIS in a big organization? How do we educate and use students to improve
                    their skills and contribute to this open source project?
                </p>
            </div>
        </div>
