...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Hands-On Cloud Native Geospatial Analytics With Apache Sedona</h2>
            ...
            <div class="abstract">
                <p>
                    This hands-on workshop will focus on using Apache Sedona for working with large-scale vector and
                    raster data. We'll use Spatial SQL and Python to perform spatial joins, zonal statistics, and raster
                    inference with large datasets that wouldn't be possible on a single machine. We'll also see how
                    cloud-native data formats like GeoParquet, Cloud Optimized GeoTiffs, and Apache Iceberg can help
                    accelerate geospatial data analysis.
                </p>
            </div>
        </div>
