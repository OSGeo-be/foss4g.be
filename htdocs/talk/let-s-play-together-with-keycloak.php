...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Let's play together with Keycloak</h2>
            ...
            <div class="abstract">
                <p>
                    Presentation about how Keycloak is used to make different open source components work together in
                    the data solutions for Brussels Mobility. Keycloak integrates the user management for Django, Django
                    CMs, Geoserver and Panoramax. A solution is implemented to create tokens for API requests and QGIS
                    connections.
                </p>
            </div>
        </div>
