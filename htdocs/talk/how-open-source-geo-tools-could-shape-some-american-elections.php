...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>How open source geo tools could shape (some) American elections</h2>

            <div class="prog-speaker">Blake Esselstyn</div>
            <div class="prog-lang icon"><?php echo $lang['LANG_EN']; ?></div>
            <div class="prog-tl">
                <div class="prog-sched icon"><?php echo $lang['PROG_THU'] ?>, 16h00 - 16h20</div>
                <div class="prog-track tr2 icon">Grote zaal</div>
            </div>

            <div class="abstract">
                <p>
                    The country's presidential election gets the most attention, but many U.S. representative
                    politicians are elected by district. Who creates and maps those districts? Often it's people like
                    me. What tools do they use? The list of options keeps growing, and ones like DistrictBuilder and
                    Districtr—not to mention multiple QGIS plugins—are open source.
                </p>
            </div>
        </div>
