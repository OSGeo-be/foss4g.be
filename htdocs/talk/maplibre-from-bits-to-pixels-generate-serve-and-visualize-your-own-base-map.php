...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>MapLibre: From Bits to Pixels. Generate, Serve, and Visualize Your Own Base Map </h2>
            ...
            <div class="abstract">
                <p>
                    In this workshop you will learn how to generate vector tiles with Planetiler, serve them using
                    Martin, and visualize your own base map with overlay tiles using MapLibre GL JS. You will get an
                    introduction to map styling with the MapLibre Style Specification and Maputnik.
                </p>
                <p>
                    Note: if you have experience with the MapLibre map stack, please consider joining me as a turtor for
                    this workshop.
                </p>
            </div>
        </div>
