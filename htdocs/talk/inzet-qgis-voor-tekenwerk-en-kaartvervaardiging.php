...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Inzet QGIS voor tekenwerk en kaartvervaardiging</h2>
            ...
            <div class="abstract">
                <p>
                    Toelichting op gebruik/inzet qgis. Wij zijn overgestapt van ESRI naar qgis om sneller en goedkoper
                    gis tekenwerk breed uit te rollen (adviseurs als tekenaars maken nu zelf kaarten). Kan tips en
                    tricks learned nader toelichten.
                </p>
            </div>
        </div>
