...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>OSGeo.NL: de verenigde stichting</h2>
            ...
            <div class="prog-slides icon"><a href="/talk-slides/osgeo-nl-de-verenigde-stichting.odp"><?php echo $lang['DOWNLOAD_SLIDES'] ?></a>
            <div class="prog-tl">
            ...
            <div class="abstract">
                <p>
                    Van oudsher is OSGeo.NL een stichting. Tegelijkertijd wordt er steeds vaker gevraagd of je ook lid
                    kan worden. Nee dus... er ligt een voorstel om een vereniging te worden. En ook een stichting te
                    blijven, mogelijk zelfs met ANBI-status. En dan kunnen we ook nog... okee, genoeg gedroomd. We gaan
                    in dit blokje de zaken eens nader toelichten en met de aanwezigen doorspreken. En mogelijk zelfs ter
                    plekke besluiten wat we gaan doen (help zelf mee OSGeo-historie te schrijven).
                </p>
            </div>
        </div>
