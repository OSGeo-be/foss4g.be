...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Basisregistraties en OpenStreetMap mixen voor map5topo kaarten</h2>
            ...
            <div class="abstract">
                <p>
                    De map5topo (<a href="https://map5topo.nl" target="_blank">https://map5topo.nl</a>) kaarten
                    bestrijken Nederland plus aangrenzend buitenland. Zij bevatten data uit bijna alle Basisregistraties
                    (BGT, BRT, BAG, BRK, NWB,..) en OpenStreetMap. Hoe wordt dit tot één datamodel 'gemixt/gebrouwen' om
                    zowel raster- als vector- tiles te realiseren?
                </p>
            </div>
        </div>
