...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Accessibility data for wheelchair users in OSM</h2>
            ...
            <div class="prog-slides icon"><a href="/talk-slides/accessibility-data-for-wheelchair-users-in-osm.pptx"><?php echo $lang['DOWNLOAD_SLIDES'] ?></a>
            <div class="prog-tl">
            ...
            <div class="abstract">
                <p>
                    The importants of accessibility data in OSM about public buildings and the link with the On Wheels
                    app
                </p>
            </div>
        </div>
