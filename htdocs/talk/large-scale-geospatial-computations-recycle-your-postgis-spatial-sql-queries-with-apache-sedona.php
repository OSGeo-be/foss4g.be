...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Large-scale Geospatial computations? Recycle your PostGIS spatial SQL queries with Apache Sedona</h2>
            ...
            <div class="abstract">
                <ul>
                    <li>GeoPostcodes Apache Sedona example use cases: scaling up existing postgis (bunch of) functions
                    </li>
                    <li>The limitations of postgis for large-scale geospatial calculations (when you are not a postgres
                        ninja)</li>
                    <li>Spatial SQL as the common denominator</li>
                </ul>
            </div>
        </div>
