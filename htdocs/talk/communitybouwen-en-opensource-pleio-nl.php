...
<body>
    ...
    <section id="main" class="container">
        ...
        <div class="content">
            <h2>Communitybouwen en Opensource.pleio.nl</h2>
            ...
            <div class="prog-slides icon"><a href="/talk-slides/communitybouwen-en-opensource-pleio-nl.pptx"><?php echo $lang['DOWNLOAD_SLIDES'] ?></a>
            <div class="prog-tl">
            ...
            <div class="abstract">
                <p>
                    Ik wil graag wat vertellen over de nieuwe richting waar we op gaan met het platform <a
                        href="Opensource.pleio.nl" target="_blank">Opensource.pleio.nl</a>, hoe de verschillende ospo's
                    hierop samenwerken, en ik zal vertellen wat dit platform biedt aan opensource projecten om te
                    schalen of om kennis uit te wisselen. Bijvoorbeeld met een projectpagina, via het forum, blogs
                    (schrijfgroep) en vraag & antwoord. </p>
            </div>
        </div>
