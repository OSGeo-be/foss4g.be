...
$lang['URL_INDEX_3'] = 'index.php?lang=fr'; /* switch to FR */
	$lang['URL_SHORT'] = 'nl';
	$lang['URL_NAME_1'] = 'Engels';
	$lang['URL_NAME_2'] = 'Nederlands';
	$lang['URL_NAME_3'] = 'Frans';
...
$lang['FOSS4G_CREDITS'] ='Colofon';
$lang['FOSS4G_PREV'] ='Vorige';
$lang['FOSS4G_NEXT'] ='Volgende';
$lang['FOSS4G_NAV'] ='Nav tonen';
$lang['FOSS4G_LOAD'] ='Aan het laden...';
...
$lang['HOME_S1_TEXT'] = 'Een dag presentaties en workshops over Open Source GIS oplossingen. Dit is de eerste Belgische bijeenkomst als lokale versie van de <a href="about.php">FOSS4G</a> wereldwijde meetings, en zal gehouden worden in verschillende talen met simultane vertaling. Blijf op de hoogte voor het hele <a href="infos.php">programma, inclusief de workshops</a>.';

// HOME SECTION TOOLS
$lang['HOME_S2_TITLE'] = 'FOSS4G Toepassingen';
$lang['HOME_S2_TEXT'] = 'Wat zijn huidige open oplossingen voor de opslag, analyse en verspreiden van geodata? In een notendop krijg je een update over verschillende toepassingen en oplossingen.';

// HOME SECTION DATA
$lang['HOME_S3_TITLE'] = 'Gegevens en Services';
$lang['HOME_S3_TEXT'] = 'Welk type data, gegevens en services zijn beschikbaar vanuit de verschillende Belgische (regionale) overheden? Wat is de toekomst van Open Data in België?';

// HOME SECTION APPS
$lang['HOME_S4_TITLE'] = 'Toepassingen';
$lang['HOME_S4_TEXT'] = 'Hoe wordt Open Source GIS gebruikt in overheden, bedrijven, onderwijs en onderzoek?';

// HOME COOKIE LAW
$lang['HOME_COOKIE_TITLE'] = 'Deze website gebruikt cookies, om verder te gaan moet je deze aanvaarden';
$lang['HOME_COOKIE_OK'] = 'Ik snap het!';
$lang['HOME_COOKIE_LAW'] = 'Meer informatie over de Europese wetgeving';
...
$lang['SPONSORS_T_TITLE'] ='Onze Sponsors';
$lang['SPONSORS_T_SUBTITLE'] ='Dank aan onze sponsors om dit mogelijk te maken';	
...
$lang['PAPERS_DEADLINE'] ='Datum: ten laatste op 24 Juli';
$lang['PAPERS_CALL2T'] ='Deadline';
$lang['PAPERS_CALL2'] ='Abstracts will be evaluated by a program committee and authors will be notified of their acceptance on the first week of August.<br />All the presentations will be made available on the event website.</p>';
...
$lang['INFO_TT_CAR'] ='Parking Tour & Taxis / 3 euros/uur';
...
$lang['REGISTRATION_SURVEYORS_TXT'] = 'De FOSS4G BELGIUM 2016 is erkend door de Federale Raad van landmeters-experten en telt mee, afhankelijk van uw effectieve aanwezigheid, voor  5 uur permanente vorming.<br/>
Voor het verkrijgen van een attest van deelname worden 25€ administratiekosten aangerekend.<br/>
Indien u een attest wil krijgen, moet u registeren met een "géomètre - landmeter" ticket. De organisatoren zullen daarna contact opnemen met u voor de formaliteiten.';
