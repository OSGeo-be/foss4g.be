			...
			<div class="prog-slot">
				...
				<div class="prog-item tr5">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/basisregistraties-en-openstreetmap-mixen-voor-map5topo-kaarten.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
			...
			<div class="prog-slot">
				...
				<div class="prog-item tr5">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/accessibility-data-for-wheelchair-users-in-osm.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
			...
			<div class="prog-slot">
				...
				<div class="prog-item tr5">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/ruimtelijke-plannen-plug-in-opnieuw-schrijven-met-chatgpt.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
						</div>
						</div>
				...
				<div class="prog-item tr3">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/algorithm-for-network-planning-and-design-in-postgis.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
			</div>
			...
			<div class="prog-slot">
				...
				<div class="prog-item tr4">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/the-open-source-software-underpinning-the-3DBAG.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
			...
			<div class="prog-slot">
				...
				<div class="prog-item tr5">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/communitybouwen-en-opensource-pleio-nl.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
			...
			<div class="prog-slot">
				<div class="prog-item tr2">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/mapbox-cloud-vector-tiles-met-attribuutinformatie.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
						</div>
						</div>
				...
				<div class="prog-item tr1">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/edugis-browsergebaseerde-kaartvisualisatie-en-analyse-voor-het-onderwijs.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
				...
				<div class="prog-item tr5">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/osgeo-nl-de-verenigde-stichting.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
				...
				<div class="prog-item tr4">
					<div class="prog-content">
						...
						<a class="prog-link prog-slides icon" target="_blank" href="/talk/let-s-play-together-with-keycloak.php" title="<?php echo $lang['PROG_MORE_INFO']; ?>"></a>
							</div>
							</div>
			</div>
