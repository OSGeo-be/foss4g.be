...
$lang['ABOUT_A_TEXT'] ='<p>Les membres actifs d\'OSGeo en Belgique sont fiers <a href="http://wiki.osgeo.org/wiki/Belgium" target="_blank">d\'annoncer la naissance du chapitre local belge</a>. Aujourd\'hui, les membres de la communauté belge sont soit actifs au sein d\'<a href="http://osgeo.nl/" target="_blank">OSGeo.nl</a>, d\'<a href="http://osgeo.asso.fr/" target="_blank">OSGeo.fr</a>, ou dans plusieurs <a href="http://www.osgeo.org/community.html" target="_blank">communautés OSGeo</a>. OsGeo Belgique agira donc comme un pont entre les communautés linguistiques et les cultures, grâce à sa composition multilingue unique.</p>
<p>Le chapitre belge travaillera activement à la promotion des solutions Geo Open Source et à la poursuite de tout le bon travail basé sur les solutions logicielles existantes. Avec l\'éco-système belge des administrations, industries et écoles, nous voulons construire un monde plus ouvert.</p>
...
$lang['SPONSORS_CALL'] ='Le comité local belge d\'organisation de FOSS4G lance un appel à sponsors.<br />
...
$lang['PAPERS_CALL_TXT1b'] ='Sessions parallèles';
$lang['PAPERS_CALL_TXT1c'] ='Sessions dev';
...
$lang['PAPERS_CALL_TXT4'] ='<strong>Une session parallèle</strong> sera centrée sur des demonstrations interactives pour les opérateurs IT, avec des cas concrets d\'utilisation et d\'implementation de FOSS4G dans des environnements spécifiques.';
...
$lang['PAPERS_SUM_ABSTRACT'] ='Une court introduction (200 caractères max.) + Une description plus longue (700 caractères max.);';
...
$lang['PAPERS_BUTTON'] ='Contact-nous afin de participer';
...
$lang['INFO_FOOD_TXT'] ='Un services offerts par nos sponsors vous sera offert pour accompagner cette journée. Un restaurant exemplaire à plus d\'un titre sera disponible sur le site. On vous y propose des aliments bio, locaux, de saison, proposant des alternatives végétariennes... Plus d\'infos à propos de <a href="http://www.biorganicfactory.be/fr/concept.php" target="_blank">Biorganic Factory</a>.';
